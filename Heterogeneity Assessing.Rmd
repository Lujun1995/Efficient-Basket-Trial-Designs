...
trial2 = function(it, h, n1.goal, K, n2.0.goal, rS, rC, n2.1.goal, theta_0, alphaS, alphaC, gamma, theta_a){
  ...
  if (toh == 1){
    ...
    if (length(K_star) > 0){
      ...
      # pool kept baskets 
      dec[K_star] = ifelse(
        as.numeric(binom.test(sum(yes_s1[K_star]+yes_s2[K_star]),
                                             sum(n1[K_star]+n2_1[K_star]),
                                             theta_0,
                                             alternative = "greater")$p.value 
                                  <= (alphaC)),1,0)
...
sim_heterogeneity2 = function(h, sim, n1.goal, K, n2.0.goal, rS, rC, n2.1.goal, theta_0, theta_a, alphaS, alphaC, gamma){
  ...
  n1.obs = rowSums(result[(4*K+4):(5*K+3),])/sim
  n2.0.obs = rowSums(result[(5*K+4):(6*K+3),],na.rm = T)/stage2_t2
  temp = (n2.0.goal/K)*(stage2_t1/track1)
  EN = sum(n1.obs)+(track1/sim)*sum(temp)+(track2/sim)*
    (sum(n2.0.obs)*(stage2_t2/track2) )
...
# no active baskets 
test_ = sim_heterogeneity2(h = 0, sim = 1000, K = 5, n1.goal = 35, n2.1.goal = 25, n2.0.goal = 75, theta_0 = .15, rS = 1, rC = 5, gamma = .52, alphaS = .07, alphaC = .05, theta_a = 0.45)
test_

# one active baskets
test_1 = sim_heterogeneity2(h = 1, sim = 1000, K = 5, n1.goal = 35, n2.1.goal = 75, n2.0.goal = 20, theta_0 = .15, rS = 1, rC = 5, gamma = .52, alphaS = .07, alphaC = .05, theta_a = 0.45)
test_1
...
# three active baskets
test_3 = sim_heterogeneity2(h = 3, sim = 1000, K = 5, n1.goal = 35, n2.1.goal = 75, n2.0.goal = 20, theta_0 = .15, rS = 1, rC = 5, gamma = .52, alphaS = .07, alphaC = .05, theta_a = 0.45)
test_3

# four active baskets
test_4 = sim_heterogeneity2(h = 4, sim = 1000, K = 5, n1.goal = 35, n2.1.goal = 75, n2.0.goal = 20, theta_0 = .15, rS = 1, rC = 5, gamma = .52, alphaS = .07, alphaC = .05, theta_a = 0.45)
test_4

# all active baskets 
test_5 = sim_heterogeneity2(h = 5, sim = 1000, K = 5, n1.goal = 35, n2.1.goal = 75, n2.0.goal = 20, theta_0 = .15, rS = 1, rC = 5, gamma = .52, alphaS = .07, alphaC = .05, theta_a = 0.45)
test_5
```
