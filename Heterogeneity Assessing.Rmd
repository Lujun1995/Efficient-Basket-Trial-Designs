...
trial = function(n1.goal, K, n2.0.goal, rS, rC, n2.1.goal, theta_0, alphaS, alphaC, gamma, theta_a){
...
sim_heterogeneity = function(h, K, sim, n1.goal, K, n2.0.goal, prob, rS, rC, n2.1.goal, theta_0, theta_a, alphaS, alphaC, gamma, prob = c(rep(theta_a,h), rep(theta_0,K-h))){
  
  set.seed(31)
  result = sapply(1:sim, trial, K = K, n1.goal = n1.goal, n2.1.goal = n2.1.goal, n2.0.goal = n2.0.goal, theta_0 = theta_0, theta_a = theta_a, rS = rS, rC = rC, gamma = gamma, alphaS = alphaS, alphaC = alphaC, prob = prob)
...
```{r}
set.seed(31)
  result = sapply(1:100, trial, K = 5, n1.goal = 7, n2.1.goal = 15, n2.0.goal = 5, theta_0 = .15, rS = 1, rC = 5, gamma = .52, alphaS = .07, alphaC = .05, theta_a = 0.45)
  
set.seed(14234)
res = trial(K = 5, n1.goal = 7, n2.1.goal = 15, n2.0.goal = 5, theta_0 = .15, rS = 1, rC = 5, gamma = .52, alphaS = .07, alphaC = .05, theta_a = 0.45)
